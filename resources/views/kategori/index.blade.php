...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <h6 class="fw-semibold " style="margin-bottom: -15px;">Berikut ini adalah kategori yang bisa digunakan untuk melabeli surat. Klik Add untuk menambah kategori baru</h6>
            {{-- modal add --}}
                        ...
                        <div class="modal-body">
                            <form action="{{ route('kategori.store') }}" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="category_name" name="category_name" required
                                        rows="3"></textarea>

                                </div>
                                <div class="mb-3">
                                    <label for="details" class="form-label">Keterangan</label>
                                    <textarea value="" type="text" class="form-control" id="details" name="details"
            ...
            <div class="col-auto d-flex justify-content-start">
                <a href="" class="btn btn-primary " data-bs-toggle="modal"
                    style=" margin-bottom: 3px; margin: left 10px;" data-bs-target="#ModalAdd"><i
                        class="bx bx-add-to-queue me-1"></i>Tambah Kategori </a>
            </div>
            {{-- TABELSO --}}
                    ...
                    <thead class=""
                        ...
                        <tr>
                            <th
                                ...
                                <span style="color: #016A70">ID Kategori
                            </th>
                            <th
                                style="background-color: #D0F288; color: white; font-size: 13px;text-align:center; border-left: 1px solid #86C8BC;">
                            ...
                            <th
                                ...
                                <span style="color: #016A70">KETERANGAN
                            </th>
                        ...
                        <tr style="padding: 5px;text-align: center; border-color:#86C8BC;  ">
                            ...
                            <td
                                ...
                                <a class="btn btn-icon btn-primary" href="#"
                                    style="height: 30px; width: 30px; background-color: #35A29F;" data-bs-toggle="modal"
                ...
                <div class="modal fade" id="ModalEdit{{ $kategori->id }}" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('kategori.update', ['kategori' => $kategori->id]) }}"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="mb-3">
